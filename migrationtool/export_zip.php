...
if ($sessions && !$sessionid) {
    ...
    echo "<b>⚠ Niedokończony eksport został znaleziony</b><br><br>";

    echo "<a href='?sessionid={$lastsession}'
    style='padding:10px 15px;background:#28a745;color:white;text-decoration:none;border-radius:4px;'>";
